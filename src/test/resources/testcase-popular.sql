...
insert into wish (item_id, member_id) values (1, 3);
insert into wish (item_id, member_id) values (1, 4);

insert into wish (item_id, member_id) values (3, 1);
insert into wish (item_id, member_id) values (3, 2);
insert into wish (item_id, member_id) values (3, 3);

insert into wish (item_id, member_id) values (5, 1);
insert into wish (item_id, member_id) values (5, 2);

insert into wish (item_id, member_id) values (6, 1);