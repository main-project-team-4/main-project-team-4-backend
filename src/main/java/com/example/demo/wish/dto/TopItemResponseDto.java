...
public class TopItemResponseDto {
    ...
    @Schema(description = "판매자 이미지", example = "https://m.hoopbro.co.kr/web/product/big/202308/68034e9c48fe22a0aab33bb52b9b0f4c.jpg")
    @JsonProperty(ParameterNameConfig.Member.IMAGE)
    private String userImageUrl;

    public TopItemResponseDto(Item entity) {
        ...
        this.userImageUrl = member.map(Member::getImage).map(URL::toString).orElse(null);
